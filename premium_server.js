...
app.post('/api/premium/upgrade', async (req, res) => {
    ...
    res.json({ success: true, message: "Payment Success! Premium Unlocked." });
});

// फक्त नवीन UI लोड करण्यासाठी
app.get('/', (req, res) => { res.sendFile(path.join(__dirname, 'public', 'premium_ui.html')); });

app.listen(5000, () => console.log('🚀 New Premium System: http://localhost:5000'));
